...
export const caseStudies: Record<string, CaseStudy> = {
  skillradar: {
    ...
    architectureHighlights: {
      es: [
        'Enrutamiento de IA Multi-Proveedor (Gemini 2.5 Flash como motor primario, soporte BYOK para OpenAI, Anthropic Claude, Groq y OpenRouter con fallback automático).',
      ...
      en: [
        'Multi-Provider AI Routing (Gemini 2.5 Flash as primary system engine, BYOK support for OpenAI, Anthropic Claude, Groq, OpenRouter with automatic fallback).',
    ...
    technicalChallenges: {
      es: [
        ...
        },
        {
          ...
          solution: 'Diseñé una canalización de enrutamiento resiliente impulsada por Vercel AI SDK que conmuta automáticamente entre Gemini 2.5 Flash, Groq y OpenRouter si el motor principal agota su cuota.',
        },
      ],
      en: [
        {
        ...
        },
        {
          ...
          solution: 'Designed a resilient routing pipeline using Vercel AI SDK that automatically fails over between Gemini 2.5 Flash, Groq, and OpenRouter if the primary engine exhausts quota.',
        },
      ],
    },
    c4Diagram: {
      ...
      timestamps: [
        {
          seconds: 0,
          timeLabel: '0:00',
          title: { es: 'Catálogo Multimedia & Populares', en: 'Multimedia Catalog & Trending' },
          description: { es: 'Exploración de la grilla de títulos con datos de TMDB API.', en: 'Browsing trending movies and TV shows powered by TMDB API.' },
        },
        {
          seconds: 15,
          timeLabel: '0:15',
          title: { es: 'Buscador & Dónde Verlo (Argentina)', en: 'Search & Streaming Availability' },
          description: { es: 'Filtro en tiempo real y disponibilidad en plataformas de streaming (HBO Max).', en: 'Live filtering and streaming availability in Argentina (HBO Max).' },
        },
        {
          seconds: 30,
          timeLabel: '0:30',
          title: { es: 'Asistente de IA Pochi & Sesión', en: 'Pochi AI Assistant & User Session' },
          description: { es: 'Interacción con el bot conversacional Gemini API y perfil personalizado (¡Hola, toni!).', en: 'Interacting with Gemini API conversational bot and personalized user session.' },
        },
        {
          seconds: 45,
          timeLabel: '0:45',
          title: { es: 'Favoritos & Créditos IFTS 11', en: 'Favorites & Academic Credits' },
          description: { es: 'Gestión de listas personales y footer de presentación del proyecto académico.', en: 'Managing user favorite lists and academic project presentation footer.' },
        },
      ],
    },
  },
