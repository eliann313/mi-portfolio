...
export const es: Translations = {
  ...
  caseStudy: {
    ...
    myRoleTitle: 'Mi Rol y Aportes Clave',
    architectureTitle: 'Arquitectura y Diseño de Sistema',
    technicalChallengesTitle: 'Desafíos Técnicos y Soluciones',
    videoDemoTitle: 'Demo Interactiva de Video',
    galleryTitle: 'Galería de Interfaz y Capturas',
    timestampsTitle: 'Capítulos y Puntos Clave del Video',
  ...
  contact: {
    title: 'Contacto',
    subtitle: 'Disponible para nuevos proyectos y oportunidades. No dudes en escribirme.',
